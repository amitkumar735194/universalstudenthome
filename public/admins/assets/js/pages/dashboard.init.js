...
var minichart4Colors = getChartColorsArray("#mini-chart5"),
    options = {
        series: [{ data: [2, 14, 2, 47, 42, 47, 47, 15, 65, 19, 14, 2, 70, 42, 15] }],
        chart: { type: "line", height: 50, sparkline: { enabled: !0 } },
        colors: minichart4Colors,
        stroke: { curve: "smooth", width: 2 },
        tooltip: {
...
var minichart4Colors = getChartColorsArray("#mini-chart6"),
    options = {
        series: [{ data: [10, 14, 22, 47, 42, 47, 47, 15, 65, 19, 18, 20, 70, 42, 5] }],
        chart: { type: "line", height: 50, sparkline: { enabled: !0 } },
        colors: minichart4Colors,
        stroke: { curve: "smooth", width: 2 },
        tooltip: {
...
(chart = new ApexCharts(document.querySelector("#mini-chart6"), options)).render();


var minichart4Colors = getChartColorsArray("#mini-chart7"),
    options = {
        series: [{ data: [18, 20, 22, 47, 42, 47, 47, 15, 5, 19, 18, 20, 70, 42, 15] }],
        chart: { type: "line", height: 50, sparkline: { enabled: !0 } },
        colors: minichart4Colors,
        stroke: { curve: "smooth", width: 2 },
        tooltip: {
...
(chart = new ApexCharts(document.querySelector("#mini-chart7"), options)).render();

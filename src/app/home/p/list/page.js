      ...
      <div className="clearfix"></div> 
        <section className="breadcrumb">
            <div className="container-fluid"> 
                ...
                <li className="active">Student Accommodation London</li>
                </ul> 
            </div>
        </section>
      ...
      <div className="featured-boxes-inner">
        <div className="m-0 row">
          ...
          >
            <div className="single-featured-box">
              <div className="icon color-fb7756">
                <Image src={`${baseUrl}/front/images/icons/comfort.jpg`}  alt="image"
               layout="fill"  
             objectFit="cover"  
             sizes="100vw" />
              </div>
          ...
          >
            <div className="single-featured-box">
              <div className="icon">
                <Image src={`${baseUrl}/front/images/icons/contact.jpg`}  alt="image"
               layout="fill"  
             objectFit="cover"  
             sizes="100vw" />
              </div>

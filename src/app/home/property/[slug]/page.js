...
import PropertyListSection from './components/property-list-section';
...
const PropertyList = ({params}) => {
  ...
  useEffect(()=>{
    fetch(`${baseUrl}api/front/get-property-by-city?slug=${slug}`,{
      method:'GET'
    }).then((response)=>{
        if(!response.ok){
      ...
      if(data.status){
        ...
        setPropertyListData(data.data.property);
        setPropertyType(data.data.propertyTypes);
        setSelectedPropertyType(data.data.propertyTypes?data.data.propertyTypes[0]._id:null)
      } 
    }).catch((error)=>{
      console.log(error)
    })
  ...
  const changePropertyType=(selectType)=>{
     
    setSelectedPropertyType(selectType);
  }
      ...
      <div className="clearfix"></div> 
        <section className="breadcrumb">
            <div className="container-fluid"> 
                ...
                <li className="active">Student Accommodation {city && city.name}</li>
                </ul> 
            </div>
        </section>
    ...
    <div className="container-fluid">
          ...
          <div className="inner-pages">
            <div className="sec-title">
              <h2>
                ...
                <span>Student Accommodation </span> {city && city.name}
              </h2>
              <div className="font-light2">
                <i className="fa fa-home" /> {city && city.totalProperty} Places to Stay
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="current" style={{overflow:'hidden'}}>Select University</div>
              ...
              <ul className="list">
                <li data-value={1} className="option selected focus">
                  ...
                  <i className="fa fa-graduation-cap" /> Kings College London
      ...
      <div className="worko-tabs">
        ...
        <div className="tabs flex-tabs">
          {propertyType && propertyType.map((pType, index)=>(
           
              <label htmlFor={`tab-one${index}`} 
              id={pType._id} 
              className="tab" 
              onClick={() => changePropertyType(pType._id)} 
              key={index}
              style={{backgroundColor:`${selectedPropertyType==pType._id?'#ff5858':''}`}}
              >
                  {pType.property_type}
              </label>
          ...
          {/*  <label for="tab-three" id="tab-three-label" className="tab">Home Stays</label> */}

          

            {propertyListData && propertyListData.map((propertyByType, index) => (
              <PropertyListSection 
                key={propertyByType._id} 
                property={propertyByType} 
  ...
  <div className="container-fluid">
    <div className="shadow-lg mb_50 box_2">
      ...
      {/* <div className="text-center drop">Drop us a line</div> */}
                ...
                <div className="nice-select form-control wide" tabIndex={0}>
                  ...
                  <ul className="list">
                    <li data-value={1} className="option selected focus">
                      ...
                      <i className="fa fa-graduation-cap" /> King s College
          ...
          >
            <div className="single-featured-box">
              <div className="icon color-fb7756">
                <img src={`${baseUrl}/front/images/icons/comfort.jpg`} alt="" />
              </div>

        ...
        <div className="navbar-brand-box">
          <Link href="/admin" className="logo logo-dark">
            <span className="logo-sm">
              <img src={`${baseUrl}/admins/assets/images/small_logo.png`} alt="" height={24} />
            </span>
            <span className="logo-lg">
              <img src={`${baseUrl}/admins/assets/images/logo.png`} alt="" height={60} />
            </span>
          </Link>
          <a href="index.html" className="logo logo-light">
            <span className="logo-sm">
              <img src={`${baseUrl}/admins/assets/images/logo-sm.svg`} alt="" height={24} />
            </span>
            <span className="logo-lg">
              <img src={`${baseUrl}/admins/assets/images/logo-sm.svg`} alt="" height={24} />
            ...
            <div data-simplebar="" style={{ maxHeight: 230 }}>
              <a href="#!" className="text-reset notification-item">
                <div className="d-flex">
                  <div className="flex-shrink-0 me-3">
                    <img
                      src={`${baseUrl}/admins/assets/images/users/avatar-3.jpg`}
              ...
              <a href="#!" className="text-reset notification-item">
                <div className="d-flex">
                  <div className="flex-shrink-0 me-3">
                    <img
                      src={`${baseUrl}/admins/assets/images/users/avatar-6.jpg`}
                      className="rounded-circle avatar-sm"
                      alt="user-pic"
                    />
                  </div>
          ...
          <div className="dropdown-menu dropdown-menu-lg dropdown-menu-end">
            <div className="p-2">
              <div className="row g-0">
                <div className="col">
                  <a className="dropdown-icon-item" href="#">
                    <img src={`${baseUrl}/admins/assets/images/brands/github.png`} alt="Github" />
                    <span>GitHub</span>
                  </a>
                </div>
                <div className="col">
                  <a className="dropdown-icon-item" href="#">
                    <img
                      src={`${baseUrl}/admins/assets/images/brands/bitbucket.png`}
                      alt="bitbucket"
                    />
                    <span>Bitbucket</span>
                  </a>
              ...
              <div className="row g-0">
                <div className="col">
                  <a className="dropdown-icon-item" href="#">
                    <img src={`${baseUrl}/admins/assets/images/brands/dropbox.png`} alt="dropbox" />
                    <span>Dropbox</span>
                  </a>
                </div>
                <div className="col">
                  <a className="dropdown-icon-item" href="#">
                    <img
                      src={`${baseUrl}/admins/assets/images/brands/mail_chimp.png`}
                      alt="mail_chimp"
                    />
                ...
                <div className="col">
                  <a className="dropdown-icon-item" href="#">
                    <img src={`${baseUrl}/admins/assets/images/brands/slack.png`} alt="slack" />
                    <span>Slack</span>
                  </a>
                </div>
              </div>
        ...
        <div className="dropdown d-inline-block">
          ...
          >
            <img
              ...
              src={`${baseUrl}/admins/assets/images/users/avatar-1.jpg`}
              alt="Header Avatar"
            />

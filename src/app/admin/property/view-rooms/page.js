                        ...
                        <div className="table-responsive">
                            ...
                            <tbody>
                                {propertyRoomData && propertyRoomData.map((item, index)=>(
                                    <tr key={index}>
                                    <td>{index+1}</td> 
                                    <td>{item.property_id && item.property_id.title}</td>
                                    ...
                                    <td>
                                        <Link href={`${baseUrl}admin/property/add-room/${item.property_id._id}/${item._id}`}>
                                        <i className="fas fa-pencil-alt" />
                                        </Link>
                                    </td>
                                   
                                    <td>
                                        <Link href="#" onClick={(e)=>deleteRooms(item._id,e)}>

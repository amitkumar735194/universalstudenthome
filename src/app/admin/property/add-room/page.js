            ...
            <div className="row">
              ...
              <div className="col-12">
                <div className="mb-3">
                  ...
                  <input className="form-control" type="text" name="title" value={roomData.title} 
                        onChange={(e)=>changeInputValue(e)} required/>
                </div>
              </div>
              <div className="col-12">
                <div className="mb-3">
                  ...
                  <textarea className="form-control" name="short_description" value={roomData.short_description} 
                        onChange={(e)=>changeInputValue(e)} required/>
                </div>
              </div>
                                    ...
                                    <div className='col-lg-12'>
                                             <ul class="amenites_ei expanded">
                                              {amenities && amenities.map((item, index)=>(
                                                <li key={index}><input type='checkbox' value={item._id} name="amenities"  onChange={(e)=>changeInputValue(e)} />
                                                <Image src={`${baseUrl}${item.image}`}   alt="image"
                                                layout="fill"  
                                              objectFit="cover"  

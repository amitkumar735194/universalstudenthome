...
const AddRooms = ({ params }) => {
  ...
  useEffect(()=>{
    console.log('this id property Id ',params)
    fetch(`${baseUrl}api/admin/auth/property/add-property/propertyFindById?property_id=${property_id}`,{
      method:"GET",
      headers:{

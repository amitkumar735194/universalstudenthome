            ...
            <div className="row">
              <div className="col-lg-12">
                <div>
                  ...
                  {/* <div className="mb-3">
                  <label for="example-text-input" className="form-label">Description</label>
                        ...
                        <div className='row'>
                                  ...
                                  <div className='col-lg-12'>
                                        <ul className="amenites_ei expanded">
                                          ...
                                          <li key={index}><input type='checkbox' value={item._id} name="Inclusive_bill"  onChange={(e)=>changeInputValue(e)}  />

                    ...
                    <div className="card-body">
                        ...
                        <div className="table-responsive">
                            ...
                            <thead>
                                ...
                                <th>Property Type</th>
                                <th>Title</th>
                                <th style={{minWidth:'250px'}}>Short Description</th>
                                <th style={{minWidth:'150px'}}>Address</th> 
                                <th style={{minWidth:'120px'}}>Rooms</th> 
                                <th style={{minWidth:'130px'}}>Left Image</th> 
                                <th style={{minWidth:'130px'}}>Right Image</th> 
                                <th>Status</th>
                                <th>Edit</th>
                                <th>Delete</th>
                                </tr>
                            ...
                            <tbody>
                                {propertyListData && propertyListData.map((item, index)=>(
                                    ...
                                    <td>{item.address}</td> 
                                    <td><Link href={`add-room/${item._id}`} style={{cursor:'pointer'}}>Add Room</Link></td> 
                                    <td><Link href={`upload-property-photo?property_id=${item._id}&position=left&uploadFor=Property`} style={{cursor:'pointer'}}>View and upload</Link></td> 
                                    ...
                                    <td>
                                        <Link href={`${baseUrl}admin/property/add-property/${item._id}`}>
